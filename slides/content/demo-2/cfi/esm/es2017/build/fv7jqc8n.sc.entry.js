...
class ClientFacingImage {
    ...
    static get style() { return ".cfi.sc-client-facing-image{position:relative}.cfi__projector.sc-client-facing-image{position:absolute;top:0;left:0;background-repeat:no-repeat;background-size:cover;background-position:50%;border:2px solid #000}.cfi__projector--round.sc-client-facing-image{border-radius:50%}.cfi__backdrop.sc-client-facing-image{background-color:#000;border:2px solid #000}.cfi__backdrop--round.sc-client-facing-image{border-radius:50%}"; }
}
